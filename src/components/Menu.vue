<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block"><img width="336" height="336" class="img-fluid img-profile rounded-circle poto mx-auto mb-2" src="@/assets/foto.jpg" alt="..." /></span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          <li class="nav-item"><RouterLink to="/" class="nav-link">Personal</RouterLink></li>
          <li class="nav-item"><RouterLink to="/skill" class="nav-link">Skill</RouterLink></li>
